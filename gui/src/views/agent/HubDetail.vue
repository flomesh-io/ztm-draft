...
<template>
	...
	<div class="pt-5 pl-5 pr-5">
		<BlockViewer text="Json" header="Hub Setting" containerClass="surface-section px-4 py-7 md:px-4 lg:px-5" >
				...
				<TabPanel>
					<template #header>
							<div class="flex align-items-center gap-2">
								<i class="pi pi-server" />	Net
							</div>
					</template>
					
					<div class="surface-section ml-5">
						<div class="font-medium text-3xl text-900 mb-5">Net</div>
